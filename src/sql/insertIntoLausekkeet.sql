...
("Cube Access WS EAZ 29","On olemassa sanonta, jonka mukaan valta ei ole mitään ilman valvontaa. Siksi Cube on varustanut upouuden Access WS EAZ -mallin vahvoilla ja helppokäyttöisillä hydraulisilla levyjarruilla, jotta voit pysähtyä nopeasti ja turvallisesti olosuhteista riippumatta. Yhdistettynä Suntourin jousitushaarukan kolhuja nielevään mukavuuteen ja Shimanon 2x8-speed vaihteiston laajaan valikoimaan tämä tarkoittaa, että tämä on pyörä, johon voit luottaa laajentaaksesi ajohorisonttiasi. Valitse seikkailusi ja lähde.",400,1,"Maastopyörä 29","cubeacces.png", 4, 'M'),
