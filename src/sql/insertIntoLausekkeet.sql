...
insert into alatuoteryhma (alakategoria,alakategoriakuva,alakategoriakuvaus,alakategoriaotsikko) VALUES
("Seisontatuki","tarvike.png","Villissä luonnossa viihtyvän kannattaa valita menopelikseen täysjousitettu maastopyörä. Täysjousitus tarkoittaa sekä jousitettua etuhaarukkaa että jousitettua pyörän takaosaa. Tarkasti säädettävän jousituksen avulla pyörän voi säätää omaan ajotyyliin sekä vallitseviin olosuhteisiin sopivaksi. 100-140 mm jousituksen tarjoavat täysjoustot sopivat parhaiten kuskeille, jotka tavoittelevat vauhtia sekä ketteryyttä niin ylä- kuin alamäissäkin. Vauhdikkaisiin alamäkiin keskittyvän kannattaa tutustua tarkemmin reilumman, 150-170 mm jouston tarjoaviin täysjoustoihin. Mikäli hakusessa on täysverinen alamäkipyörä, freeride- ja downhill-pyörät sopivat tarkoitukseen parhaiten.","Oikeanlaiset varusteet tekevät pyöräilystä mukavampaa!"),
("Lokasuoja","tarvike.png","Villissä luonnossa viihtyvän kannattaa valita menopelikseen täysjousitettu maastopyörä. Täysjousitus tarkoittaa sekä jousitettua etuhaarukkaa että jousitettua pyörän takaosaa. Tarkasti säädettävän jousituksen avulla pyörän voi säätää omaan ajotyyliin sekä vallitseviin olosuhteisiin sopivaksi. 100-140 mm jousituksen tarjoavat täysjoustot sopivat parhaiten kuskeille, jotka tavoittelevat vauhtia sekä ketteryyttä niin ylä- kuin alamäissäkin. Vauhdikkaisiin alamäkiin keskittyvän kannattaa tutustua tarkemmin reilumman, 150-170 mm jouston tarjoaviin täysjoustoihin. Mikäli hakusessa on täysverinen alamäkipyörä, freeride- ja downhill-pyörät sopivat tarkoitukseen parhaiten.","Oikeanlaiset varusteet tekevät pyöräilystä mukavampaa!"),
("Ketjut","tarvike.png","Villissä luonnossa viihtyvän kannattaa valita menopelikseen täysjousitettu maastopyörä. Täysjousitus tarkoittaa sekä jousitettua etuhaarukkaa että jousitettua pyörän takaosaa. Tarkasti säädettävän jousituksen avulla pyörän voi säätää omaan ajotyyliin sekä vallitseviin olosuhteisiin sopivaksi. 100-140 mm jousituksen tarjoavat täysjoustot sopivat parhaiten kuskeille, jotka tavoittelevat vauhtia sekä ketteryyttä niin ylä- kuin alamäissäkin. Vauhdikkaisiin alamäkiin keskittyvän kannattaa tutustua tarkemmin reilumman, 150-170 mm jouston tarjoaviin täysjoustoihin. Mikäli hakusessa on täysverinen alamäkipyörä, freeride- ja downhill-pyörät sopivat tarkoitukseen parhaiten.","Oikeanlaiset varusteet tekevät pyöräilystä mukavampaa!"),
("Polkimet","tarvike.png","Villissä luonnossa viihtyvän kannattaa valita menopelikseen täysjousitettu maastopyörä. Täysjousitus tarkoittaa sekä jousitettua etuhaarukkaa että jousitettua pyörän takaosaa. Tarkasti säädettävän jousituksen avulla pyörän voi säätää omaan ajotyyliin sekä vallitseviin olosuhteisiin sopivaksi. 100-140 mm jousituksen tarjoavat täysjoustot sopivat parhaiten kuskeille, jotka tavoittelevat vauhtia sekä ketteryyttä niin ylä- kuin alamäissäkin. Vauhdikkaisiin alamäkiin keskittyvän kannattaa tutustua tarkemmin reilumman, 150-170 mm jouston tarjoaviin täysjoustoihin. Mikäli hakusessa on täysverinen alamäkipyörä, freeride- ja downhill-pyörät sopivat tarkoitukseen parhaiten.","Oikeanlaiset varusteet tekevät pyöräilystä mukavampaa!"),
("Korit","tarvike.png","Villissä luonnossa viihtyvän kannattaa valita menopelikseen täysjousitettu maastopyörä. Täysjousitus tarkoittaa sekä jousitettua etuhaarukkaa että jousitettua pyörän takaosaa. Tarkasti säädettävän jousituksen avulla pyörän voi säätää omaan ajotyyliin sekä vallitseviin olosuhteisiin sopivaksi. 100-140 mm jousituksen tarjoavat täysjoustot sopivat parhaiten kuskeille, jotka tavoittelevat vauhtia sekä ketteryyttä niin ylä- kuin alamäissäkin. Vauhdikkaisiin alamäkiin keskittyvän kannattaa tutustua tarkemmin reilumman, 150-170 mm jouston tarjoaviin täysjoustoihin. Mikäli hakusessa on täysverinen alamäkipyörä, freeride- ja downhill-pyörät sopivat tarkoitukseen parhaiten.","Oikeanlaiset varusteet tekevät pyöräilystä mukavampaa!"),
("Soittokello","tarvike.png","Villissä luonnossa viihtyvän kannattaa valita menopelikseen täysjousitettu maastopyörä. Täysjousitus tarkoittaa sekä jousitettua etuhaarukkaa että jousitettua pyörän takaosaa. Tarkasti säädettävän jousituksen avulla pyörän voi säätää omaan ajotyyliin sekä vallitseviin olosuhteisiin sopivaksi. 100-140 mm jousituksen tarjoavat täysjoustot sopivat parhaiten kuskeille, jotka tavoittelevat vauhtia sekä ketteryyttä niin ylä- kuin alamäissäkin. Vauhdikkaisiin alamäkiin keskittyvän kannattaa tutustua tarkemmin reilumman, 150-170 mm jouston tarjoaviin täysjoustoihin. Mikäli hakusessa on täysverinen alamäkipyörä, freeride- ja downhill-pyörät sopivat tarkoitukseen parhaiten.","Oikeanlaiset varusteet tekevät pyöräilystä mukavampaa!");
