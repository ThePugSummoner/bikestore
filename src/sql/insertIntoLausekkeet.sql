...
("Cube Access WS EAZ","On olemassa sanonta, jonka mukaan valta ei ole mitään ilman valvontaa. Siksi Cube on varustanut upouuden Access WS EAZ -mallin vahvoilla ja helppokäyttöisillä hydraulisilla levyjarruilla, jotta voit pysähtyä nopeasti ja turvallisesti olosuhteista riippumatta. Yhdistettynä Suntourin jousitushaarukan kolhuja nielevään mukavuuteen ja Shimanon 2x8-speed vaihteiston laajaan valikoimaan tämä tarkoittaa, että tämä on pyörä, johon voit luottaa laajentaaksesi ajohorisonttiasi. Valitse seikkailusi ja lähde.",400,1,"Etujousto","maastopyörä kuva"),

("Orbea Oiz H10 TR","Oiz tietää, kuinka vaikeaa on rynnätä huipulle ja kiivetä tulostauluille ja voittajien palkintokorokkeille. Orbean ei tarvitse laatia pitkää sukupuuta, sillä kaksi maailmanmestaruutta on riittävä todiste siitä, että Oiz on todellinen täysverinen. Oiz on synonyymi aidolle maastohiihdolle, minkä vuoksi sen läsnäolo maailmancupissa on kaikkialla läsnä. Oiz on yksi markkinoiden kevyimmistä, jäykimmistä ja tehokkaimmista pyöristä, halusitpa sitten kilpailla tai vain ajella. Oizissa on se, mitä tarvitset: ei ole parempaa asetta, jolla voi tähdätä huipulle.",3849,1,"Täysjousto","maastopyörä kuva"),
...
3669,1,"Täysjousto","maastopyörä kuva"),

("Serious Rockville 29 Lite","Urheilullinen Rockville 27,5 -versio on erinomainen maastopyörä lähtötasolle. Kevyessä alumiinirungossa on tasapainoinen varustelu ja urheilullisen raikas mutta ajaton muotoilu.Rockville on sekä vapaa-ajan että arjen maastopyörä, joka tarjoaa erinomaista vastinetta rahalle. Rockvillen laadukkaat ja monipuoliset komponentit tarkoittavat, että pyörä voidaan todella käyttää monenlaisilla pinnoilla.",219,1,"Maastopyörä 29","maastopyörä kuva"),

("Cube Access WS EAZ 29","On olemassa sanonta, jonka mukaan valta ei ole mitään ilman valvontaa. Siksi Cube on varustanut upouuden Access WS EAZ -mallin vahvoilla ja helppokäyttöisillä hydraulisilla levyjarruilla, jotta voit pysähtyä nopeasti ja turvallisesti olosuhteista riippumatta. Yhdistettynä Suntourin jousitushaarukan kolhuja nielevään mukavuuteen ja Shimanon 2x8-speed vaihteiston laajaan valikoimaan tämä tarkoittaa, että tämä on pyörä, johon voit luottaa laajentaaksesi ajohorisonttiasi. Valitse seikkailusi ja lähde.",400,1,"Maastopyörä 29","maastopyörä kuva"),

("Orbea Oiz H10 TR 27.5","Oiz tietää, kuinka vaikeaa on rynnätä huipulle ja kiivetä tulostauluille ja voittajien palkintokorokkeille. Orbean ei tarvitse laatia pitkää sukupuuta, sillä kaksi maailmanmestaruutta on riittävä todiste siitä, että Oiz on todellinen täysverinen. Oiz on synonyymi aidolle maastohiihdolle, minkä vuoksi sen läsnäolo maailmancupissa on kaikkialla läsnä. Oiz on yksi markkinoiden kevyimmistä, jäykimmistä ja tehokkaimmista pyöristä, halusitpa sitten kilpailla tai vain ajella. Oizissa on se, mitä tarvitset: ei ole parempaa asetta, jolla voi tähdätä huipulle.",3849,1,"Maastopyörä 27.5","maastopyörä kuva"),
...
("Vitus Razor intl.","Feeling a road bike surge forward when you press on the pedals and the excitement that comes from the ease of acceleration - that’s how road cycling should feel. Whether you are stepping over your first road bike or pulling away from lights on a regular commute, the Vitus Razor delivers that same sensation of speed and freedom. And it never gets old.",759,3,"ENDURANCE","Maantiepyörä kuva"),

("BMC Teammachine SLR Four","BMC TEAMMACHINE SLR FOUR, MUSTA (ANTHRACITE/BRUSHED ALLOY)",4999,3,"ENDURANCE","Maantiepyörä kuva"),


("Cannondale CAAD Optimus Prime","Exceptional Aluminum PerformanceEverything Cannondale know about aluminum road bikes in one space – refined tube profiles, precision butting, and double-pass welds create frames that are lighter and ride better than the competitors’ high-ticket alloy offerings.",879,3,"Thriathlon","Maantiepyörä kuva"),

("Polygon Strattos KVG 100","Strattos S4 on rakennettu kevyen ja reagoivan rungon ympärille, jossa on täyshiilikuituhaarukka. Tässä pyörässä yhdistyvät kevyt, kestävä ja luotettava kevytmetallirunko sekä todistettu suorituskyky. Se on täydellinen pyörä innokkaille maantiepyöräilijöille, urheilullisille harrastajille ja jokapäiväisille työmatkapyöräilijöille. Aja koko päivä, koe enemmän.",969,3,"Thriathlon","Maantiepyörä kuva"),
...
("CatEye OH2200 Yamabiko Soittokello","Erittäin tyylikäs ja äänekäs polkupyöräkello, jossa on erinomainen ääni ja joka on valmistettu messingistä kaupunkipyörääsi. Kiinnitin on valmistettu alumiinista.",16,5,"Soittekello","Tarvike kuva"),
...
("Red Cycling Products Front Basket","Nopeasti kiinnitettävä ja irroitettäva pyörän etukori. Kevyt etukori kiinnitetään ohjaustankoon silmän räpäyksessä ilman työkaluja. Korissa on näppärä kantokahva, joka tekee korista mainion avun esimerkiksi ruokaostoksille. Korin tiivis verkkomateriaali estää pienempienkin esineiden tippumisen korista ajon aikana. Ehdoton varuste kaupunkiajoon.",18,5,"Korit","Tarvike kuva"),

("Basil Jasmin Baboushka Pyöräkori Lapset","Basil Jasmin on polkupyöräkori, joka on tarkoitettu lasten polkupyörän etuosaan. Kiinnitetään kahdella koukulla, ja siinä on värikäs koristenauha, Babouschka-nukke ja kantokahva.",21,5,"Korit","Tarvike kuva"),
...
("Xpedo Spry Polkimet","Ultrakevyt XPEDO Spry -alustapoljin on ihanteellinen MTB-pyörään! 14 terästappia per poljin (7 per kulutuspinta) takaa optimaalisen voimansiirron ja pidon, joten pysyt MTB-pyöräsi hallinnassa vaikeimmissakin olosuhteissa. Erittäin kestävä CroMoly-teräsakseli, jossa on tiivistetty teollisuuslaakeri ja kaksi liukulaakeria, takaa luotettavan pitkän aikavälin suorituskyvyn. Yksinkertainen, tyylikäs ulkonäkö ja värivalikoima tekevät Sprystä halutun litteän polkimen.",92,6,"Polkimet","Komponentti kuva"),
