...
("Red Cycling Products Front Basket","Nopeasti kiinnitettävä ja irroitettäva pyörän etukori. Kevyt etukori kiinnitetään ohjaustankoon silmän räpäyksessä ilman työkaluja. Korissa on näppärä kantokahva, joka tekee korista mainion avun esimerkiksi ruokaostoksille. Korin tiivis verkkomateriaali estää pienempienkin esineiden tippumisen korista ajon aikana. Ehdoton varuste kaupunkiajoon.",18,5,"Korit","Tarvike kuva", 34),

("Basil Jasmin Baboushka Pyöräkori Lapset","Basil Jasmin on polkupyöräkori, joka on tarkoitettu lasten polkupyörän etuosaan. Kiinnitetään kahdella koukulla, ja siinä on värikäs koristenauha, Babouschka-nukke ja kantokahva.",21,5,"Korit","Tarvike kuva", 32),
...
-- Komponentit alkavat
insert into tuote (nimi,kuvaus,hinta,trnro,alakategoria,kuva, saldo) VALUES
("DARTMOOR Stream Polkimet","Kevyt ja vakaa. Valetut alumiinipolkimet Stream Pro takaavat parhaan pidon 10 nastalla.",38,6,"Polkimet","Komponentti kuva", 20),

("Xpedo Spry Polkimet","Ultrakevyt XPEDO Spry -alustapoljin on ihanteellinen MTB-pyörään! 14 terästappia per poljin (7 per kulutuspinta) takaa optimaalisen voimansiirron ja pidon, joten pysyt MTB-pyöräsi hallinnassa vaikeimmissakin olosuhteissa. Erittäin kestävä CroMoly-teräsakseli, jossa on tiivistetty teollisuuslaakeri ja kaksi liukulaakeria, takaa luotettavan pitkän aikavälin suorituskyvyn. Yksinkertainen, tyylikäs ulkonäkö ja värivalikoima tekevät Sprystä halutun litteän polkimen.",92,6,"Polkimet","Komponentti kuva", 28),

("Eclat Stroke Ketju","Eclat Stroke Ketju musta",29,6,"Ketjut","Komponentti kuva", 34),

("KMC X9SL Polkupyörän ketju 9-vaihteinen","Hopeanvärisellä 9-vaihteisella X9SL-ketjulla KMC esittelee erittäin kevyen (SL), ruosteenestoisen ja erittäin kestävän kilpapyörä- ja maastoketjun Shimanon, Campagnolon ja SRAMin 9-vaihteisille vaihteistoille.",38,6,"Ketjut","Komponentti kuva", 56);
