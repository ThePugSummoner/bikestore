...
","lasten_kategoria.png"),
 ...
 ("Komponentit","Ei se pyörä ilman rattaita kulje!","Komponentteja joka lähtöön. Ei tarvitse miettiä mistä niitä saa, kun alta klikkaa vaan!","komponentti_kategoria.jpg");
